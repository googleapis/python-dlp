...
class DlpServiceTransport(abc.ABC):
    ...
    def delete_inspect_template(
        ...
        [dlp.DeleteInspectTemplateRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_job_trigger(
        ...
        [dlp.DeleteJobTriggerRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_dlp_job(
        ...
        [dlp.DeleteDlpJobRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def cancel_dlp_job(
        ...
        [dlp.CancelDlpJobRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_stored_info_type(
        ...
        [dlp.DeleteStoredInfoTypeRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def finish_dlp_job(
        ...
        [dlp.FinishDlpJobRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
