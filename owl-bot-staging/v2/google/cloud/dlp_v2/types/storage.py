...
class CustomInfoType(proto.Message):
    ...
    class Dictionary(proto.Message):
        ...
        word_list = proto.Field(proto.MESSAGE, number=1, oneof='source',
            message='CustomInfoType.Dictionary.WordList',
        )

        cloud_storage_path = proto.Field(proto.MESSAGE, number=3, oneof='source',
    ...
    class DetectionRule(proto.Message):
        ...
        class LikelihoodAdjustment(proto.Message):
            ...
            fixed_likelihood = proto.Field(proto.ENUM, number=1, oneof='adjustment',
                enum='Likelihood',
            )
        ...
        class HotwordRule(proto.Message):
            ...
            hotword_regex = proto.Field(proto.MESSAGE, number=1,
                message='CustomInfoType.Regex',
            )

            proximity = proto.Field(proto.MESSAGE, number=2,
                message='CustomInfoType.DetectionRule.Proximity',
            )

            likelihood_adjustment = proto.Field(proto.MESSAGE, number=3,
    ...
    likelihood = proto.Field(proto.ENUM, number=6,
        enum='Likelihood',
    )

    dictionary = proto.Field(proto.MESSAGE, number=2, oneof='type',
        message=Dictionary,
    )

    regex = proto.Field(proto.MESSAGE, number=3, oneof='type',
        message=Regex,
    )

    surrogate_type = proto.Field(proto.MESSAGE, number=4, oneof='type',
        message=SurrogateType,
    )

    stored_type = proto.Field(proto.MESSAGE, number=5, oneof='type',
        message='StoredType',
    )

    detection_rules = proto.RepeatedField(proto.MESSAGE, number=7,
        message=DetectionRule,
    )

    exclusion_type = proto.Field(proto.ENUM, number=8,
        enum=ExclusionType,
    )
...
class DatastoreOptions(proto.Message):
    ...
    partition_id = proto.Field(proto.MESSAGE, number=1,
        message='PartitionId',
    )

    kind = proto.Field(proto.MESSAGE, number=2,
...
class CloudStorageOptions(proto.Message):
    ...
    class FileSet(proto.Message):
        ...
        regex_file_set = proto.Field(proto.MESSAGE, number=2,
            message='CloudStorageRegexFileSet',
        )

    file_set = proto.Field(proto.MESSAGE, number=1,
        message=FileSet,
    )
    ...
    file_types = proto.RepeatedField(proto.ENUM, number=5,
        enum='FileType',
    )

    sample_method = proto.Field(proto.ENUM, number=6,
        enum=SampleMethod,
    )
...
class BigQueryOptions(proto.Message):
    ...
    identifying_fields = proto.RepeatedField(proto.MESSAGE, number=2,
        message='FieldId',
    )
    ...
    sample_method = proto.Field(proto.ENUM, number=4,
        enum=SampleMethod,
    )

    excluded_fields = proto.RepeatedField(proto.MESSAGE, number=5,
        message='FieldId',
    )
...
class StorageConfig(proto.Message):
    ...
    class TimespanConfig(proto.Message):
        ...
        timestamp_field = proto.Field(proto.MESSAGE, number=3,
            message='FieldId',
        )

        enable_auto_population_of_timespan_config = proto.Field(proto.BOOL, number=4)

    datastore_options = proto.Field(proto.MESSAGE, number=2, oneof='type',
        message='DatastoreOptions',
    )

    cloud_storage_options = proto.Field(proto.MESSAGE, number=3, oneof='type',
        message='CloudStorageOptions',
    )

    big_query_options = proto.Field(proto.MESSAGE, number=4, oneof='type',
        message='BigQueryOptions',
    )

    hybrid_options = proto.Field(proto.MESSAGE, number=9, oneof='type',
        message='HybridOptions',
    )

    timespan_config = proto.Field(proto.MESSAGE, number=6,
...
class DatastoreKey(proto.Message):
    ...
    entity_key = proto.Field(proto.MESSAGE, number=1,
        message='Key',
    )
...
class RecordKey(proto.Message):
    ...
    datastore_key = proto.Field(proto.MESSAGE, number=2, oneof='type',
        message='DatastoreKey',
    )

    big_query_key = proto.Field(proto.MESSAGE, number=3, oneof='type',
        message='BigQueryKey',
    )
...
class BigQueryField(proto.Message):
    ...
    table = proto.Field(proto.MESSAGE, number=1,
        message='BigQueryTable',
    )
...
class TableOptions(proto.Message):
    ...
    identifying_fields = proto.RepeatedField(proto.MESSAGE, number=1,
        message='FieldId',
    )
